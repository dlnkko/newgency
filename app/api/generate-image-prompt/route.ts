...
- **Lighting (MANDATORY)**: Single-source directional light with realistic softness; natural highlight and shadow behavior; no studio setups; dynamic range similar to good iPhone 13 exposure (balanced, not HDR crunchy).
...
- **ABSOLUTE NEGATIVE PROMPTS**: NO beauty-filtered / airbrushed skin, NO hyper-detailed pores, NO glamour-shot post-processing, NO uniform plastic fabrics, NO perfectly flat lighting with many fillers, NO synthetic oversharpening, NO cinematic grading, NO device frames or UI elements.
