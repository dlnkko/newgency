...
The lighting MUST be authentic nighttime outdoor lighting as if someone is genuinely recording outside at night with their iPhone. Include: streetlights and car headlights visible in background with realistic light falloff and authentic shadows, natural moonlight casting soft, hyperrealistic shadows with proper edge softness, realistic iPhone recording at night with authentic grain, natural noise, and lower exposure typical of nighttime smartphone footage, warm artificial lights from buildings or streetlamps with realistic color temperature and light diffusion, authentic night atmosphere with hyperrealistic light interaction. The video should look exactly like real nighttime footage recorded on an iPhone - not professional lighting, but genuine iPhone night recording with all its characteristic qualities (authentic grain, natural noise, realistic exposure, hyperrealistic shadows with proper density and softness, genuine light sources with realistic falloff, etc.). Every shadow must be hyperrealistic with natural softness and proper density. Every light source must have realistic diffusion and color temperature. **CRITICAL - Background must be completely sharp and in focus, no blur whatsoever, exactly as iPhone cameras record in vertical mode.**`;
            ...
            return isScene4Plus
              ? `${hyperrealismBase}\n\n**LIGHTING: DAY OUTSIDE (OUTSIDE NATURAL):**
Soft bright outdoor sun — NOT harsh midday. Key light front-right slightly elevated; soft shadows under chin and opposite cheek; warm sun + cool sky fill; soft hyperrealistic skin/fabric; organic bokeh if background soft. Background sharp when iPhone-style full-depth. Subject toward camera when UGC.`
              : `${hyperrealismBase}\n\n**LIGHTING: DAY OUTSIDE — OUTSIDE NATURAL (REFERENCE VISUAL):**
Match authentic **soft** outdoor daylight (park / urban green): bright but **flattering** sun — late morning, early afternoon, or light overcast — **avoid harsh midday crunch**. Primary light from **front-right of subject, slightly elevated**; soft highlights on forehead, nose, cheekbones (not blown out). **Soft subtle shadows** under chin, on far side of face, gentle under nose — chiaroscuro for form, never dramatic. Warm sunlight on skin + slightly cooler ambient in shadows from sky/foliage. **Soft hyperrealistic** skin (natural pores/peach fuzz where light grazes, subtle oil sheen on forehead/cheeks — not plastic). Natural fabric folds, moderate shallow DoF with **organic** background bokeh when appropriate. Colors balanced and natural — iPhone color science. Talking-to-camera / candid UGC energy. **CRITICAL - When vertical iPhone UGC requires sharp background, keep background readable; otherwise natural outdoor depth is OK.**`;
